	      	...
	      	<div class="span12">
	      		...
	      		<div class="widget-content">
					...
					<div class="tab-pane" id="formcontrols">
								<form action="add_group" method="post" id="edit-profile" class="form-horizontal">
									<fieldset>
										
																			
										
										<div class="control-group">											
											<label class="control-label" for="name"><?php echo lang('client_group_name'); ?></label>
											<div class="controls">
										...
										<div class="control-group">											
											<label class="control-label" for="description"><?php echo lang('client_group_description'); ?></label>
											<div class="controls">
										...
										<div class="form-actions">
											<button type="submit" id="submit" class="btn btn-primary"><?php echo lang('client_group_new_group'); ?></button> 
                ...
                <thead>
                  <tr>
                    <th> <?php echo lang('client_group_name'); ?> </th>
                    <th> <?php echo lang('client_group_description'); ?></th>
                    <th> <?php echo lang('category_options'); ?></th>
                  </tr>
                </thead>
                ...
                <tbody>
					...
					<?php
					  ...
					  echo "<td><a class='btn btn-small btn-success' href='edit_category/". $row['id'] . "'>EDIT</a>";
					  echo "&nbsp;<a class='btn btn-danger btn-small' href='delete_category/". $row['id'] . "'>X</a></td>";
					  echo "</tr>";
